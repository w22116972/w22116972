...
**Priority topic:** 31
**Evidence status:** Optional architecture decision. No service-mesh deployment
or production benefit is claimed by this case study.
...
3. Pilot one non-critical service path with explicit success and removal criteria.
