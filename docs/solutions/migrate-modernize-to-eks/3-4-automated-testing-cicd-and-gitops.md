...
**Priority topic:** 15
**Evidence status:** CI-built images, Helm releases, deployment gates, and Argo
CD patterns are retained. Adoption scope must be verified per workload; a Git
commit alone is not runtime evidence.
...
- a Git revert restores safe desired state and is confirmed through live traffic;
