...
**Category:** Migration
**Priority topic:** 30
**Evidence status:** Optional datacenter-exit pattern. The retained case study
does not prove a VMware migration, AWS Transform deployment, or AWS Application
Migration Service program.
