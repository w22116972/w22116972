...
**Priority topic:** 20
**Evidence status:** Multi-AZ, disruption, backup, restore, and recovery patterns
are retained. A completed backup job proves recovery-point creation, not usable
application recovery or achievement of an RTO/RPO.
...
1. Define business impact, RTO, RPO, minimum service, and data-loss tolerance per
   workload and dependency.
