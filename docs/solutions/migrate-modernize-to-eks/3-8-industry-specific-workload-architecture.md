...
**Priority topic:** 34
**Evidence status:** Discovery and architecture framework only. No semiconductor,
manufacturing, public-sector, or financial-services customer outcome is claimed
...
- allowed-service, region, encryption, identity, logging, and retention decisions;
