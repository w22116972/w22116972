...
**Priority topic:** 22
**Evidence status:** Build, dependency, image, and manifest scanning patterns are
retained. A complete production signing, admission, and runtime-detection estate
is a target architecture unless separately evidenced.
